...
sqlEngine = create_engine('mysql+pymysql://Avani:root@127.0.0.1/db', pool_recycle=3600)
...
UPLOAD_FOLDER='/home/sonu/flasktutorial/dish-tagger/files/' 
ALLOWED_EXTENSIONS = set(['xlsx', 'csv','xls'])
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:root@localhost:3306/task1db'
...
@app.route('/jsonres', methods=['GET','POST'])
@login_required
def jsonres():
